...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Sonrakı",sPrevious:"Əvvəlki"},sEmptyTable:"No data available in table",sInfo:"Göstərilir _START_ dən _END_ ümumi _TOTAL_ Sətirlər",sInfoEmpty:"Göstərilir 0 dan 0 cəmi 0 Sətirlər",
sInfoFiltered:"(_MAX_ sətirdən filterlənmiş nəticələr)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Göstərilən _MENU_ sətirlər",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Axtar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Uyğun qeydlər tapılmadı"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
